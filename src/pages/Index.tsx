    ...
    <div className="w-full">
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden px-8 py-8 -mt-96">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          ...
          <SMSBubble 
            delay={0} 
            className="absolute top-[calc(18%+80pt)] md:top-[calc(18%+80pt)] max-w-[60%] text-sm md:text-base"
          ...
          <div className="absolute left-[3%] top-[calc(64%-25pt)] md:left-24 md:top-[calc(70%-25pt)]">
            <div 
          ...
          {/* Top right bubble with glow */}
            <div className="absolute right-[8%] top-[calc(29%+60pt)] md:right-20 md:top-[calc(24%+60pt)]">
